...
2. Sign in using your 'your_own_email<span style="color:red">@outlook.com</span>' If you don't have one create one beforehand. You must press 'Yes.'

<img src="img/notebooks_azure_sign_in.png" alt="drawing" width="500"/>

3. You will be asked to create an User ID. Select one and press 'Save.'
